...
describe('Tier One: Campuses', () => {
  ...
  describe('Redux', () => {
    ...
    describe('reducer', () => {
      ...
      it('*** returns the initial state by default', () => {
        ...
        const action = { type: 'GET', campuses };
  ...
  describe('Sequelize Model', () => {
    ...
    it('*** requires name and address', async () => {
      ...
      try {
        await campus.save();
        throw new Error('name and address cannot be null');
      } catch (err) {
        expect(err.message).to.contain(
          'notNull Violation: campus.name cannot be null'
        );
        expect(err.message).to.contain(
          'notNull Violation: campus.address cannot be null'
        );
      }
    });
